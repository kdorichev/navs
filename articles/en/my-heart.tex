...
\hypersetup{				% Гиперссылки
	...
	pdftitle={My Heart Christ's Home},   % Заголовок
	pdfauthor={Robert Boyd Munger},      % Автор
	pdfsubject={Christian life basics},      % Тема
	pdfcreator={Konstantin Dorichev}, % Создатель
	% pdfproducer={LaTeX}, % Производитель
	pdfkeywords={Jesus}  {Christ} {Christianity} {faith} {lordship}, % Ключевые слова
